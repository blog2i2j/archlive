...
startdir=$(pwd)
cd /tmp
wget -O kernel.spec "http://cvs.fedoraproject.org/viewvc/rpms/kernel/F-11/kernel.spec?revision=1.1711"
links -no-g -source http://cvs.fedoraproject.org/viewvc/rpms/kernel/F-11/ >list
