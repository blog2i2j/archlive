...
修改DEFAULT\_REPO\_URL="http://mirrors.kernel.org/archlinux"
DEFAULT\_ARCH=i686

然后 sudo sh ./arch-bootstrap.sh -a x86\_64 /mnt/
...

修改 /mnt/etc/pacman.conf中 Architecture = x86\_64 或者 Architecture = i686
